            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.agency.createConfirm') }}">
                        @csrf
                        <div class="mb-3 row">
                            <label class="col-sm-2 fw-bold required-mark">Agency Name</label>
                            <div class="col-sm-10">
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-2 fw-bold required-mark">Tel</label>
                            <div class="col-sm-10">
                        ...
                        <div class="line"></div><br>
                        <div class="mb-3 row">
                            <label class="col-sm-2 fw-bold required-mark">Address</label>
                            <div class="col-sm-10">
