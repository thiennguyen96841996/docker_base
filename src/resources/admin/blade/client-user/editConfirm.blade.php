...
@section('CONTENTS')
    ...
    <form id="confirm-form" method="POST" action="{{ route('admin.client-user.update', request()->input('id')) }}">
        @csrf
        @method('PUT')
        ...
        <input type="button" value="back" data-post-url="{{ route('admin.client-user.edit', request()->input('id')) }}">
