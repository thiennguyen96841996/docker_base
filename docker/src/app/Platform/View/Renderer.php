...
use GLC\Platform\Support\ArrayAccessible;
...
class Renderer implements ArrayAccess, RendererContract
{
     ...
     * ViewModelを取得する。
     *
     * @return \GLC\Platform\View\Contracts\ViewModel|null ViewModelの実装を持つオブジェクト or null
     */
     ...
     * ViewModelを設定する。
     *
     * @param  \GLC\Platform\View\Contracts\ViewModel|null $viewModel ViewModelの実装を持つオブジェクト
     * @return void
     */
